...
\definecolor{QuartoInternalColor11}{rgb}{0.00,0.40,0.79}
...
\BuiltInTok{print}\NormalTok{(}\StringTok{"✓ Setup complete"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Highlighting}
\textcolor{black}{ModuleNotFoundError: No module named 'mysuperlearner.evaluation'}
...
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{Cell}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{In[1]}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{, line 15}\textcolor{QuartoInternalColor2}{}
...
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     16}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor5}{from}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor6}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{mysuperlearner}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{.}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{error\_handling}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor6}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor5}{import}\textcolor{QuartoInternalColor2}{ ErrorType}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     18}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor7}{# Set random seed for reproducibility}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor1}{ModuleNotFoundError}\textcolor{QuartoInternalColor2}{: No module named 'mysuperlearner.evaluation'}
\end{Highlighting}
...
\begin{Highlighting}
\textcolor{black}{ValueError: No learners provided. Either pass learners to the constructor (SuperLearner(learners=[...])) or use fit\_explicit(X, y, base\_learners) (deprecated).}
\textcolor{black}{}\textcolor{QuartoInternalColor1}{---------------------------------------------------------------------------}\textcolor{QuartoInternalColor2}{}
...
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{Cell}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{In[2]}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{, line 36}\textcolor{QuartoInternalColor2}{}
...
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     35}\textcolor{QuartoInternalColor2}{     warnings.simplefilter(}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{always}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{)}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{---> }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{36}\textcolor{QuartoInternalColor2}{     }\textcolor{QuartoInternalColor2}{sl}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{.}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{fit}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{(}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{X}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{,}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{y}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{)}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     38}\textcolor{QuartoInternalColor2}{     }\textcolor{QuartoInternalColor5}{print}\textcolor{QuartoInternalColor2}{(}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor9}{\textbackslash{}n}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{Warnings captured:}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{)}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     39}\textcolor{QuartoInternalColor2}{     }\textcolor{QuartoInternalColor5}{for}\textcolor{QuartoInternalColor2}{ warning }\textcolor{QuartoInternalColor10}{in}\textcolor{QuartoInternalColor2}{ w:}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{File }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{/fh/fast/gilbert\_p/agartlan/gitrepo/mysuperlearner/mysuperlearner/super\_learner.py:218}\textcolor{QuartoInternalColor2}{, in }\textcolor{QuartoInternalColor3}{SuperLearner.fit}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor11}{(self, X, y, sample\_weight, store\_X, groups)}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    193}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor6}{}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor2}{"""Fit Super Learner ensemble.}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    194}\textcolor{QuartoInternalColor2}{ }
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    195}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor2}{Parameters}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{   (...)}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    215}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor2}{    Fitted estimator.}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    216}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor2}{"""}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    217}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor5}{if}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor5}{self}\textcolor{QuartoInternalColor2}{.learners }\textcolor{QuartoInternalColor10}{is}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor5}{None}\textcolor{QuartoInternalColor2}{:}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{--> }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{218}\textcolor{QuartoInternalColor2}{     }\textcolor{QuartoInternalColor5}{raise}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor12}{ValueError}\textcolor{QuartoInternalColor2}{(}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    219}\textcolor{QuartoInternalColor2}{         }\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{No learners provided. Either pass learners to the constructor }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    220}\textcolor{QuartoInternalColor2}{         }\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{(SuperLearner(learners=[...])) or use fit\_explicit(X, y, base\_learners) }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    221}\textcolor{QuartoInternalColor2}{         }\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{(deprecated).}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    222}\textcolor{QuartoInternalColor2}{     )}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    223}\textcolor{QuartoInternalColor2}{ base\_learners = }\textcolor{QuartoInternalColor5}{self}\textcolor{QuartoInternalColor2}{.learners}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{    224}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor7}{# Store feature names before validation converts to array}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor1}{ValueError}\textcolor{QuartoInternalColor2}{: No learners provided. Either pass learners to the constructor (SuperLearner(learners=[...])) or use fit\_explicit(X, y, base\_learners) (deprecated).}
\end{Highlighting}
...
\begin{verbatim}
/tmp/ipykernel_4084750/3860650377.py:36: DeprecationWarning:

fit_explicit() is deprecated and will be removed in v0.3.0. Use SuperLearner(learners=base_learners).fit(X, y) instead.
\end{verbatim}
...
\begin{verbatim}
/tmp/ipykernel_4084750/2796442553.py:39: DeprecationWarning:
...
Warnings captured: 5
  ...
  Warning 1:
    ...
    Message: fit_explicit() is deprecated and will be removed in v0.3.0. Use SuperLearner(learners=base_learners)...
...
\NormalTok{        sl\_5a.fit\_explicit(X\_min, y\_min, learners\_5a)}
    \BuiltInTok{print}\NormalTok{(}\StringTok{"✗ ERROR: Should have raised RuntimeError!"}\NormalTok{)}
\ControlFlowTok{except} \PreprocessorTok{RuntimeError} \ImportTok{as}\NormalTok{ e:}
    \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f"✓ Correctly raised RuntimeError:"}\NormalTok{)}
...
\NormalTok{    sl\_5b.fit\_explicit(X\_min, y\_min, learners\_5b)}
    ...
    \BuiltInTok{print}\NormalTok{(}\StringTok{"✓ Fit succeeded with warning:"}\NormalTok{)}
    \ControlFlowTok{for}\NormalTok{ warning }\KeywordTok{in}\NormalTok{ w:}
        \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f"  }\SpecialCharTok{\{}\NormalTok{warning}\SpecialCharTok{.}\NormalTok{category}\SpecialCharTok{.}\VariableTok{\_\_name\_\_}\SpecialCharTok{\}}\SpecialStringTok{: }\SpecialCharTok{\{}\NormalTok{warning}\SpecialCharTok{.}\NormalTok{message}\SpecialCharTok{\}}\SpecialStringTok{"}\NormalTok{)}
...
----------------------------------------------------------------------
✓ Fit succeeded with warning:
  DeprecationWarning: fit_explicit() is deprecated and will be removed in v0.3.0. Use SuperLearner(learners=base_learners).fit(X, y) instead.
  UserWarning: Warning: 1 learner(s) failed in final refit: {'failing'}. Ensemble will use 2 learners.

Failed learners: {'failing'}
Working learners: 2
Can make predictions: True
\end{verbatim}
...
\BuiltInTok{print}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{Mean ± Std across folds:"}\NormalTok{)}
...
\begin{Highlighting}
\textcolor{black}{NameError: name 'evaluate\_super\_learner\_cv' is not defined}
\textcolor{black}{}\textcolor{QuartoInternalColor1}{---------------------------------------------------------------------------}\textcolor{QuartoInternalColor2}{}
...
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{Cell}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{In[7]}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{, line 21}\textcolor{QuartoInternalColor2}{}
...
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{---> }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{21}\textcolor{QuartoInternalColor2}{ results\_cv = }\textcolor{QuartoInternalColor2}{evaluate\_super\_learner\_cv}\textcolor{QuartoInternalColor2}{(}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     22}\textcolor{QuartoInternalColor2}{     X\_cv, y\_cv,}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     23}\textcolor{QuartoInternalColor2}{     learners\_cv,}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     24}\textcolor{QuartoInternalColor2}{     sl\_cv,}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     25}\textcolor{QuartoInternalColor2}{     outer\_cv=}\textcolor{QuartoInternalColor4}{5}\textcolor{QuartoInternalColor2}{,}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     26}\textcolor{QuartoInternalColor2}{     random\_state=}\textcolor{QuartoInternalColor4}{42}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     27}\textcolor{QuartoInternalColor2}{ )}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     29}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor5}{print}\textcolor{QuartoInternalColor2}{(}\textcolor{QuartoInternalColor8}{f}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor9}{\textbackslash{}n}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{Results shape: }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor13}{\{}\textcolor{QuartoInternalColor2}{results\_cv.shape}\textcolor{QuartoInternalColor13}{\}}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{)}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{     30}\textcolor{QuartoInternalColor2}{ }\textcolor{QuartoInternalColor5}{print}\textcolor{QuartoInternalColor2}{(}\textcolor{QuartoInternalColor8}{f}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{Columns: }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor13}{\{}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor5}{list}\textcolor{QuartoInternalColor2}{(results\_cv.columns)}\textcolor{QuartoInternalColor13}{\}}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor8}{"}\textcolor{QuartoInternalColor2}{)}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor1}{NameError}\textcolor{QuartoInternalColor2}{: name 'evaluate\_super\_learner\_cv' is not defined}
\end{Highlighting}
...
Failed learner uses neutral probability (0.5)
\end{verbatim}

\begin{verbatim}
/tmp/ipykernel_4084750/2301653980.py:32: DeprecationWarning:
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Final refit error handling} & ✅ Complete & Catches all
exceptions, adds dummy learners, issues warnings \\
\textbf{Prediction error tracking} & ✅ Complete & Tracks errors, uses
neutral probability (0.5), warns user \\
\textbf{Min viable learners} & ✅ Complete & Configurable threshold for
minimum successful learners \\
\textbf{Comprehensive diagnostics} & ✅ Complete & Detailed error
records with phase, type, severity \\
\textbf{Failed learner tracking} & ✅ Complete &
\texttt{failed\_learners\_} attribute tracks all failures \\
\textbf{Graceful degradation} & ✅ Complete & Dummy learners ensure
ensemble continues working \\
\textbf{CV error tracking} & ✅ Complete & Errors during
cross-validation are tracked \\
\textbf{Sample weight support} & ✅ Complete & Full support with
TypeError handling \\
\end{longtable}
