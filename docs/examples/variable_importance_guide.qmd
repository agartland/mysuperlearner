...
compute_variable_importance(
    ...
    n_jobs=1                 # Parallel jobs (not yet implemented)
)
```
...
sl_memory_efficient = ExtendedSuperLearner(method='nnloglik', folds=5)
sl_memory_efficient.fit_explicit(X, y, learners, store_X=False)
...
# 1. Fit SuperLearner
sl_workflow = ExtendedSuperLearner(method='nnloglik', folds=5)
sl_workflow.fit_explicit(X, y, learners, store_X=True)
