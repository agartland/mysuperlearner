...
We'll create a **challenging** binary classification problem with limited signal: only 3 out of 20 features are informative, with 10% label noise added to make prediction difficult.
...
X, y = make_classification(
    n_samples=1000,
    n_features=20,
    n_informative=3,      # Only 3 informative features (challenging!)
    n_redundant=2,        # 2 redundant features
    n_repeated=0,
    n_clusters_per_class=2,
    flip_y=0.1,          # Add 10% label noise
    class_sep=0.5,       # Reduce class separation
    random_state=42
)
...
print(f"Informative features: 3 (15% of total)")
...
We'll use diverse base learners including a simple intercept-only baseline (equivalent to R's `SL.mean`):
...
learners = [
    ('Intercept', InterceptOnlyEstimator()),  # Simple baseline (R's SL.mean)
...
print("\nBase Learners:")
print("  - Intercept: Predicts training set mean (baseline)")
print("  - RandomForest: Ensemble of decision trees")
print("  - LogisticRegression: Linear classifier")
